 ...
 * @author ZuraNation
 */
public class verifikasipeserta extends javax.swing.JFrame {

    /**
     * Creates new form verifikasipeserta
     */
    public verifikasipeserta() {
        initComponents();
    }
    ...
    private void jLabelSeminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelSeminarMouseClicked
        verifikasipesertaseminar usm = null;

        try {
            usm = new verifikasipesertaseminar ();
        } catch (Exception ex) {
    ...
    private void jLabelHiburanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelHiburanMouseClicked
        verifikasipesertalomba ulb = null;

        try {
            ulb = new verifikasipesertalomba ();
        } catch (Exception ex) {
    ...
    private void jLabelLombaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelLombaMouseClicked
        verifikasipesertahiburan uhb = null;

        try {
            uhb = new verifikasipesertahiburan ();
        } catch (Exception ex) {
            Logger.getLogger(userseminar.class.getName()).log(Level.SEVERE, null, ex);
        }
        uhb.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(verifikasipeserta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new verifikasipeserta().setVisible(true);
            }
        });
    }
